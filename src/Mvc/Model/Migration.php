...
class Migration
{
     ...
     *
     */
    public static function setup($database, $verbose = false): void
    {
     ...
     * @param bool $skip
     */
    public static function setSkipAutoIncrement($skip): void
    {
        self::$skipAI = $skip;
    }
     ...
     * @param string $path
     */
    public static function setMigrationPath($path): void
    {
